...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'grok' | 'openclaw' | 'agy' | 'rig';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'grok' || parsed.agentType === 'openclaw' || parsed.agentType === 'agy' || parsed.agentType === 'rig'
            ? parsed.agentType
            : 'claude';
